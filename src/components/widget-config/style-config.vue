  ...
  <section>
    ...
    <el-form-item label="按钮样式：" v-if="selectWg.style.hasOwnProperty('btnStyle')">
      ...
      <div v-else>
        ...
        <el-form-item label="按钮大小" v-if="selectWg.style.btnStyle.hasOwnProperty('borderradius')">
          <el-input-number
            v-model="selectWg.style.btnStyle.widths"
            :min="10"
            :max="355"
            :step="5"
            step-strictly
            size="small"
            @change="val=>selectWg.style.btnStyle.width = `${val}px`"
          />
        </el-form-item>
      </div>
    </el-form-item>
